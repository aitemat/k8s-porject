...
# 5. Kiểm tra va ứng dụng
## 5.1 Test delete app xong deploy lại xem dữ liệu còn không.
```sh
...
## 5.2 Kiểm tra pod có Persitent Volume (PV) đang kết nối qua iSCSI target không?
```sh
...
/dev/sda         15G  125M   15G   1% /var/lib/kubelet/pods/e9f817ae-ad96-4f2a-896e-6086d748a1e1/volumes/kubernetes.io~iscsi/pv-10g
...
```
Khi tạo pv liên kết với iSCSI thì thư mục disk PV tạo ra sẽ được mount vào mục iscsi cuả k8s
