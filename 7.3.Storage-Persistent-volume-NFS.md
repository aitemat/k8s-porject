...
spec:
  ...
  template:
    ...
    spec:
      ...
      nodeSelector:
        kubernetes.io/hostname: k8s-nodew1 # ch▒~Mn c▒~Q ▒~Q▒~Knh node worker nfs sẽ deploy pod replicas=2, khi ▒~Qó 2 pod n▒| y sẽ tạo trên cùng 1 node worker
      volumes:
        - name: volume-nginx
...
# Tổng kết
<img src="/images/nginx-deployment7.jpg">  
