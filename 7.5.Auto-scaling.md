...
```  
Thêm `--kubelet-insecure-tls` vào dưới `--kubelet-insecure-tls`  
...
NAME                                        REFERENCE          TARGETS   MINPODS   MAXPODS   REPLICAS   AGE
horizontalpodautoscaler.autoscaling/kubia   Deployment/kubia   0%/30%    1         5         1          11m
horizontalpodautoscaler.autoscaling/nginx   Deployment/nginx   19%/30%   1         5         2          48m

NAME                      READY   UP-TO-DATE   AVAILABLE   AGE
deployment.apps/hamster   2/2     2            2           17d
deployment.apps/kubia     1/1     1            1           11m
